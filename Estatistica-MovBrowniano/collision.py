    ...
    def init_particles(self, n, radius, styles=None):
        ...
        for i, rad in enumerate(radius):
            ...
            while not self.place_particle(rad, styles):
                pass
            if i == 0:
                self.particles[0].x = 0.5
                self.particles[0].y = 0.5
                self.particles[0].vx = 0
                self.particles[0].vy = 0
                self.particles[0].mass = 0.0000055
            else:
                self.particles[i].vx *= 4
                self.particles[i].vy *= 4
